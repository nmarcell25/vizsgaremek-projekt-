	...
	<div class="container">
		<div class="col-lg-12">
			<div class="row">
				...
				<div class="form-group">
						<select name="type" id="" class="badge badge-secondary">
							<option value="1">Megosztás</option>
							<option value="0">Csak feltöltés</option>
						</select>
				</div>
				</div>
			</div>
			...
			<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)" accept="image/x-png,image/gif,image/jpeg" style="display: none">
			  <div id="drop">
			  	<span id="dname" class="text-center">Húzza ide a fájlt/fájlokat <br> vagy <br> <label for="chooseFile"><strong>Válasszon fájlt</strong></label></span>
			  </div>
			  <div id="list"></div>
			  <div class="col-md-12">
					<button class="btn btn-sm btn-primary btn-block col-md-2  offset-md-10"><i class="fa fa-upload"></i> Feltöltés</button>
				</div>
