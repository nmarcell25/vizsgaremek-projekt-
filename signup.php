...
<div class="container-fluid">
  <form action="" id="signup-frm">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label for="" class="control-label">Középsőnév</label>
    ...
    <div class="form-group">
      <label for="" class="control-label">Telefonszám</label>
      <input type="text" name="contact" required="" class="form-control">
    </div>
    <div class="form-group">
      <label for="" class="control-label">Cím</label>
    ...
    <button class="button btn btn-info btn-sm">Létrehozás</button>
  </form>
</div>
